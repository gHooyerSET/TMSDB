        ...
        public string GetTrips()
        {
            ...
            try
            {
                ...
                while (sqlReader.Read())
                {
                    ...
                    stringBuilder.Append(",");
                    stringBuilder.Append(sqlReader.GetString(Trip_CarrierIDIndex).ToString());
                    stringBuilder.Append(",");
                    stringBuilder.Append(sqlReader.GetString(Trip_RouteIDIndex));
                    stringBuilder.Append(",");
        ...
        public string GetTrips(int RouteID)
        {
            ...
            try
            {
                ...
                while (sqlReader.Read())
                {
                    stringBuilder.Append(sqlReader.GetInt32(Trip_IDIndex).ToString());
                    stringBuilder.Append(",");
                    stringBuilder.Append(sqlReader.GetInt32(Trip_CarrierIDIndex).ToString());
                    stringBuilder.Append(",");
                    stringBuilder.Append(sqlReader.GetString(Trip_RouteIDIndex));
                    stringBuilder.Append(",");
                    stringBuilder.Append(sqlReader.GetString(Trip_StartCityIndex));
